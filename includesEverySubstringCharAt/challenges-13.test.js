...
const firstLetters = (strs) => strs.map(str => str.substring(0, 1));
...
const standardizePhoneNumbers = (phoneNumbers) => phoneNumbers.map(str => str.substring(1, 4) + str.substring(6, 9) + str.substring(10));
